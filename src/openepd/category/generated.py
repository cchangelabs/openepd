...
def get_category_definitions() -> tuple[dict[str, Any], ...]:
    ...
    return (
        ...
        },
        {
            ...
            "declared_unit": NonNegativeAmount(qty=1.0, unit="m^3"),
        ...
        },
        {
            ...
            "declared_unit": NonNegativeAmount(qty=1.0, unit="t"),
            "parent": "ConstructionMaterials",
        },
        {
            "unique_name": "GMU",
        ...
        },
        {
            ...
            "declared_unit": NonNegativeAmount(qty=1.0, unit="m^2"),
            "parent": "ColdFormedSteel",
        },
        {
        ...
        },
        {
            ...
            "declared_unit": NonNegativeAmount(qty=1.0, unit="item"),
        ...
        },
        {
            ...
            "declared_unit": NonNegativeAmount(qty=1.0, unit="m"),
            "parent": "NetworkInfrastructure",
        },
        {
        ...
        },
        {
            ...
            "declared_unit": NonNegativeAmount(qty=1000.0, unit="sqft"),
            "parent": "Finishes",
        },
        {
        ...
        },
        {
            ...
            "masterformat": "09 90 00 Painting and Coating",
            "declared_unit": NonNegativeAmount(qty=1.0, unit="kg"),
        ...
        },
        {
            ...
            "masterformat": "26 00 00 Electrical",
            "declared_unit": NonNegativeAmount(qty=1.0, unit="kWh"),
            "parent": "Electrical",
        },
        {
        ...
        },
        {
            ...
            "hierarchical_name": "Electrical >> LowVoltageElectricalDistribution >> FloorEquipmentBoxes >> ElectricalBoxAccs",
            "short_name": "Accessories",
        ...
        },
        {
            ...
            "hierarchical_name": "Electrical >> LowVoltageElectricalDistribution >> FloorEquipmentBoxes >> ElectricalWallBoxes",
        ...
        },
        {
            ...
            "hierarchical_name": "Electrical >> LowVoltageElectricalDistribution >> FloorEquipmentBoxes >> ElectricalJunctionBoxes",
        ...
        },
        {
            ...
            "masterformat": "26 00 00 Electrical",
            "declared_unit": NonNegativeAmount(qty=1.0, unit="kW"),
            "parent": "Electrical",
        },
        {
        ...
        },
        {
            ...
            "declared_unit": NonNegativeAmount(qty=1.0, unit="tkm"),
            "parent": "ConstructionMaterials",
        },
        {
        ...
        },
        {
            ...
            "hierarchical_name": "Specialties >> WallDoorProtection",
        ...
        },
        {
            ...
            "hierarchical_name": "Specialties >> WallDoorProtection >> ProtectiveRailsGuards",
            "short_name": "Rails & Guards",
            "description": "Linear handrails, guards, and protective strips for interior areas where extra protection is needed against wear, traffic, or impact.",
            "masterformat": "10 26 00 Wall and Door Protection",
            "declared_unit": NonNegativeAmount(qty=1.0, unit="m"),
            "parent": "WallDoorProtection",
        },
        {
            "unique_name": "ProtectiveSurfaceCoverings",
            "display_name": "Wall & Door Protective Coverings",
            "hierarchical_name": "Specialties >> WallDoorProtection >> ProtectiveSurfaceCoverings",
            "short_name": "Coverings",
            "description": "Protective wall panels for interior areas where extra protection is needed against wear, traffic, or impact.",
            "masterformat": "10 26 00 Wall and Door Protection",
            "declared_unit": NonNegativeAmount(qty=1.0, unit="m^2"),
            "parent": "WallDoorProtection",
        },
        {
            ...
            "hierarchical_name": "Specialties >> InformationSpecialties",
        ...
        },
        {
            ...
            "hierarchical_name": "Specialties >> InteriorSpecialties",
            "short_name": "Interior",
        ...
        },
        {
            ...
            "hierarchical_name": "Specialties >> FireplacesStoves",
        ...
        },
        {
            ...
            "hierarchical_name": "Specialties >> SafetySpecialties",
            "short_name": "Safety",
        ...
        },
        {
            ...
            "hierarchical_name": "Specialties >> StorageSpecialties",
            "short_name": "Storage",
            "masterformat": "10 50 00 Storage Specialties",
            "parent": "Specialties",
        },
        {
            ...
            "hierarchical_name": "Specialties >> ExteriorSpecialties",
            "short_name": "Exterior",
            "description": "Specialties add to the aesthetics of the building, protect people and the building from the weather, and flag poles.",
        ...
        },
        {
            ...
            "hierarchical_name": "Specialties >> OtherSpecialties",
            "short_name": "Other",
