...
class BundleMixin:
    ...
    def _serialize_rel_asset_for_csv(cls, rel_asset: list[str] | str | None) -> str | None:
        """Serialize rel_asset for CSV storage. Multiple assets are joined with semicolons."""
    ...
    def _deserialize_rel_asset_from_csv(cls, rel_asset_str: str | None) -> list[str] | str | None:
        """Deserialize rel_asset from CSV storage. Semicolon-separated values become lists."""
