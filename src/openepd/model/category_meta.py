...
def _iter_category_fields(
...
) -> Iterator[tuple[str, pyd.fields.ModelField]]:
    """
    ...
    """
    yield from category_cls.__fields__.items()


def _get_field_type(field: pyd.fields.ModelField) -> type:
    """
...
def _is_field_deprecated(field: pyd.fields.ModelField) -> bool:
    """
    ...
    """
    return bool(field.field_info.extra.get("deprecated", False))
