...
class IndicatorAmountsByLifecycleModule(pyd.RootModel[dict[str, LifecycleModuleAmounts]]):
    """
...
class HarmonizationFactorBase(BaseOpenEpdSchema, ABC):
    description: str | None = pyd.Field(
        ...
        examples=["All electricity consumption at the Harford plant is covered by on-site solar or green-e RECs."],
        max_length=2000,
    )
    ...
    multiply_after: list[Annotated[str, pyd.StringConstraints(max_length=200)]] = pyd.Field(
