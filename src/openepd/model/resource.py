...
class ResourceObject(BaseOpenEpdSchema):
    ...
    alt_ids: list[str] | None = pyd.Field(
        ...
        example=["4a90591d-1a40-40e3-b72f-e5853d286b15", "0cddd245-a2c6-477b-afc1-3070ddf0ef9b"],
        default=None,
        max_items=255,
    )
    name: str = pyd.Field(
    ...
    link: str | None = pyd.Field(
        ...
        example="https://asphaltepd.org/epd/d/aRU5Po/",
        default=None,
        max_length=200,
    )
...
class SoftwareResource(ResourceObject):
    primary_function: SoftwarePrimaryFunction | None = pyd.Field(
