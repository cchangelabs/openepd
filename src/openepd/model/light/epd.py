...
class EpdWithDepsV0(EpdV0, title="EPD (with Dependencies)"):
    ...
    manufacturer: Org | None = pyd.Field(description=MANUFACTURER_DESCRIPTION, default=None)  # type: ignore[assignment]
    epd_developer: Org | None = pyd.Field(description=DEVELOPER_DESCRIPTION, default=None)  # type: ignore[assignment]
    program_operator: Org | None = pyd.Field(description=PROGRAM_OPERATOR_DESCRIPTION, default=None)  # type: ignore[assignment]
    third_party_verifier: Org | None = pyd.Field(description=THIRD_PARTY_VERIFIER_DESCRIPTION, default=None)  # type: ignore[assignment]
