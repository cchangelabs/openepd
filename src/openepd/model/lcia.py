...
class ScopeSetCarbon(ScopeSet):
    ...
    allowed_units: ClassVar[str | tuple[str, ...] | None] = ("kgCO2e", "kgCO2")
...
class ImpactSet(ScopesetByNameBase):
    ...
    GWP_GHG: ScopeSetGwp | None = pydantic.Field(
        default=None,
        description=(
    ...
    co2_r_carb: ScopeSetCarbon | None = pydantic.Field(
        alias="co2-r-carb",
        default=None,
        description=(
