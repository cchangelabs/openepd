...
class MassTimberV1(BaseOpenEpdHierarchicalSpec):
    ...
    _CATEGORY_META = CategoryMeta(
        ...
        alt_names=["Oriented Strand Lumber", "Shop-Fabricated Wood Trusses", "Cross-Laminated Timber", "CrossLam", "Glued-Laminated Wood", "Glue Laminated Timber", "Glued Laminated Timber", "Glued Laminated Beam"],
...
class SheathingPanelsV1(BaseOpenEpdHierarchicalSpec):
    ...
    _CATEGORY_META = CategoryMeta(
        ...
        alt_names=["Structural Wood Panels", "Stressed Skin Panels", "Cementitious Reinforced Panels", "Plywood", "Oriented Strand Board", "OSB", "Plywood and OSB Sheathing", "MDF", "Medium Density Fiberboard"],
